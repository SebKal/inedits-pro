			...
			<tr><td align="center">
				<div style="line-height: 30px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						...
						afin de compléter votre inscription, merci de valider votre adresse email en cliquant sur le bouton ci-dessous.
					</span></font>
				</div>
