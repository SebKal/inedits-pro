...
<title>Bienvenue chez Inedits | La première plateforme d'écriture collaborative</title>
<style type="text/css">
			...
			<tr><td align="center">
				...
				<div style="line-height: 44px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
						Invitation à découvrir In&dits
					</span></font>
				</div>
				<!-- padding --><div style="height: 30px; line-height: 30px; font-size: 10px;">&nbsp;</div>
			</td></tr>
			<tr><td align="center">
				<div style="line-height: 30px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						Bonjour,
						<?php if (!$user || empty($user) || $user === ' ') : ?>
							<span><?php echo $anonym ?></span>
						<?php else : ?>
							<span style="text-transform: capitalize;"><?php echo $user ?></span>
						<?php endif; ?>
						pense que vous avez un vrai talent littéraire, pour en savoir plus, cliquez sur le bouton ci-dessous :
					</span></font>
				</div>
							...
							<tr><td align="center">
								<div style="line-height: 24px;">
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
										Découvrez la première plateforme d'écriture collaborative et écrivons les histoires de demain.
									</span></font>
								</div>
							</td></tr>
						</table>
