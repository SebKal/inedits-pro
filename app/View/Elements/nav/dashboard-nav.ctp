        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <span class="username username-hide-on-mobile"><?php echo $currentUser['name']; ?></span>
                ...
                <li class="dropdown dropdown-quick-sidebar-toggler">
                    <?php echo $this->Html->link('<i class="icon-logout"></i>', array('controller' => 'users', 'action' => 'logout', 'admin' => false), array('escape' => false, 'class' => 'dropdown-toggle')); ?>
                </li>
